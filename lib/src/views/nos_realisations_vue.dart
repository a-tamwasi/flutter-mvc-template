...
class NosRealisationsVue extends StatelessWidget {
  ...
  Widget _construireGalerieRealisations(BuildContext context) {
    final realisations = [
      ...
      {
        'titre': 'Jardin Anglais Romantique',
        'description': 'Création d\'un jardin champêtre aux inspirations anglaises',
        'image': 'assets/jardin 4.jpeg',
        'categorie': 'Conception de Jardin',
        'superficie': '320 m²',
        'duree': '4 semaines',
        'budget': '12 000 - 18 000 €',
        'style': 'Anglais romantique',
        'details': 'Massifs de roses anciennes, allées sinueuses en gravier, tonnelle romantique, mixed-borders colorés et banc en fer forgé sous glycine centenaire.',
      },
      {
        'titre': 'Jardin Contemporain Urbain',
        'description': 'Aménagement moderne pour espace citadin avec terrasses étagées',
        'image': 'assets/jardin 5.jpeg',
        'categorie': 'Aménagement Paysager',
        'superficie': '150 m²',
        'duree': '3 semaines',
        'budget': '18 000 - 25 000 €',
        'style': 'Contemporain urbain',
        'details': 'Terrasses étagées en béton ciré, mur végétal vertical, éclairage LED intégré, plantes architecturales et salon de jardin design.',
      },
      {
        'titre': 'Complexe Aquatique Familial',
        'description': 'Piscine familiale avec toboggan et aire de jeux aquatiques',
        'image': 'assets/piscine 4.jpeg',
        'categorie': 'Piscines & Terrasses',
        'superficie': '400 m²',
        'duree': '7 semaines',
        'budget': '38 000 - 50 000 €',
        'style': 'Familial ludique',
        'details': 'Piscine avec zone peu profonde, toboggan intégré, jeux d\'eau pour enfants, terrasses antidérapantes et espace barbecue couvert.',
      },
      {
        'titre': 'Bassin Naturel Écologique',
        'description': 'Piscine naturelle avec système de filtration biologique',
        'image': 'assets/piscine 5.jpeg',
        'categorie': 'Piscines & Terrasses',
        'superficie': '280 m²',
        'duree': '6 semaines',
        'budget': '32 000 - 42 000 €',
        'style': 'Naturel écologique',
        'details': 'Bassin de baignade naturelle, zone de régénération plantée, rochers naturels, cascade écologique et terrasses en bois durable.',
      },
    ];
